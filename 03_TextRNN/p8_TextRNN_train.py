...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        textRNN=TextRNN(FLAGS.num_classes, FLAGS.learning_rate, FLAGS.batch_size, FLAGS.decay_steps, FLAGS.decay_rate,FLAGS.sentence_len,
        ...
        for epoch in range(curr_epoch,FLAGS.num_epochs):
            ...
            for start, end in zip(range(0, number_of_training_data, batch_size),range(batch_size, number_of_training_data, batch_size)):
                ...
                feed_dict = {textRNN.input_x: trainX[start:end],textRNN.dropout_keep_prob: 0.5}
