...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        textRCNN=TextRCNN(FLAGS.num_classes, FLAGS.learning_rate, FLAGS.batch_size, FLAGS.decay_steps, FLAGS.decay_rate,FLAGS.sentence_len,
        ...
        for epoch in range(curr_epoch,FLAGS.num_epochs):
            ...
            if epoch % FLAGS.validate_every==0:
                eval_loss, eval_acc=do_eval(sess,textRCNN,testX,testY,batch_size)
        ...
        test_loss, test_acc = do_eval(sess, textRCNN, testX, testY, batch_size)
    pass
